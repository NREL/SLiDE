...
@variable(cge,X>=smallval,start=1)
@variable(cge,Y>=smallval,start=1)
@variable(cge,W>=smallval,start=1)
@variable(cge,PX>=smallval,start=1)
@variable(cge,PY>=smallval,start=1)
@variable(cge,PW>=smallval,start=1)
@variable(cge,PL>=smallval,start=1)
@variable(cge,PK>=smallval,start=1)
@variable(cge,CONS>=smallval,start=1)
