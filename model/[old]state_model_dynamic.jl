...
(blueNOTE, set, idx) = _model_input(years, d, set)
...
# for r in regions
#     blueNOTE[:c0][r] = get(blueNOTE[:c0],r,0.0)
#     blueNOTE[:bopdef0][r] = get(blueNOTE[:bopdef0],r,0.0)
#     blueNOTE[:hhadj][r] = get(blueNOTE[:hhadj],r,0.0)
# end
